...
const Filters = ({onFilter}) => {
    ...
    return (
      <div className="grid gap-4 grid-cols-1">
        <div id="muscles" className="rounded-lg border p-2 shadow-md group">
        ...
        <div id="category" className="rounded-lg border p-2 shadow-md group">
        ...
        <div id="equipament" className="rounded-lg border p-2 shadow-md group">
